...
import followininc.followin.InstagramDialog.OAuthDialogListener;
...
public class InstagramApp {
	...
	public InstagramApp(Context context, String clientId, String clientSecret,
		...
		mAuthUrl = AUTH_URL
				...
				+ "&redirect_uri="
				+ mCallbackUrl
				+ "&response_type=code&display=touch&scope=basic+likes+comments+relationships+public_content+follower_list";
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					//TODO
					//URL url = new URL(API_URL + "/users/self/?access_token=" + mAccessToken);
					...
					Log.e("Profile_picture", data_obj.getString(TAG_PROFILE_PICTURE));
