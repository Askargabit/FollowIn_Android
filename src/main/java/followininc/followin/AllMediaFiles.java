	...
	private Handler handler2 = new Handler(new Handler.Callback() {
		...
		public boolean handleMessage(Message msg) {
			if (msg.what == InstagramApp.WHAT_FINALIZE) {
				...
				Toast.makeText(AllMediaFiles.this, "Check your network.",
	...
	private void getAllMediaImages() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					Log.e("Media","Here-1 " + mApp.getTOken());
					// URL url = new URL(mTokenUrl + "&code=" + code);
					JSONParser jsonParser = new JSONParser();
					//JSONObject jsonObject = jsonParser.getJSONFromUrlByGet("https://api.instagram.com/v1/users/" + userInfo.get(InstagramApp.TAG_ID)
					//				+ "/media/recent/?client_id=" + ApplicationData.CLIENT_ID + "&count=" + userInfo.get(InstagramApp.TAG_COUNTS));
					JSONObject jsonObject = jsonParser.getJSONFromUrlByGet("https://api.instagram.com/v1/users/" + userInfo.get(InstagramApp.TAG_ID)
